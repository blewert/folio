...
root.render(<main>
    ...
    <article>
        <header>
            ...
            <button>
                Show all 12 projects <PiArrowRightBold />
            </button>
        </header>
        <div className="picture-grid">
            <div className="cell">
                <img src="https://picsum.photos/400/300?1"/>
                <h1>NCNR Teleoperation</h1>
                <p>The something project was an interesting project which did x y and z</p>
                <div className="tags">
                    <span>C++</span>
                    <span>Software</span>
                    <span>VR</span>
            ...
            <div className="cell">
                <img src="https://picsum.photos/350/150?3"/>
                <h1>NCNR Teleoperation</h1>
                <p>The something project was an interesting project which did x y and z</p>
            </div>

            <div className="cell">
                <img src="https://picsum.photos/300/600?4"/>
                <h1>NCNR Teleoperation</h1>
                <p>The something project was an interesting project which did x y and z</p>
            </div>

            <div className="cell">
                <img src="https://picsum.photos/150/250?5"/>
                <h1>NCNR Teleoperation</h1>
                <p>The something project was an interesting project which did x y and z</p>
            </div>

            <div className="cell">
                <img src="https://picsum.photos/150/300?6"/>
                <h1>NCNR Teleoperation</h1>
                <p>The something project was an interesting project which did x y and z</p>
            </div>
        </div>
